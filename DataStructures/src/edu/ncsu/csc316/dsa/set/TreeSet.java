...
public class TreeSet<E extends Comparable<E>> extends AbstractSet<E> {
    ...
    /** for this tree set we will use a RED Black tree since they are my favorite ! */
    ...
    @Override
    public Iterator<E> iterator() { return tree.iterator(); }

    @Override
    public void add(E value) { tree.put(value, value); }

    @Override
    public boolean contains(E value) { return tree.get(value) == null ? false : true; }

    @Override
    public E remove(E value) { return tree.remove(value); }
