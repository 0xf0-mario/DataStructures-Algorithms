...
public class HashSet<E> extends AbstractSet<E> {
    ...
    /** map which uses delegation to a hasMap in order to behave like a Hash Set */
    private Map<E, E> map;
     ...
     * @param isTesting helps enable a more predicatable hash 
     */
    ...
    @Override
    public Iterator<E> iterator() { return map.iterator(); }

    @Override
    public void add(E value) { map.put(value, value); }

    @Override
    public boolean contains(E value) { return map.get(value) == value; }

    @Override
    public E remove(E value) { return map.remove(value); }
