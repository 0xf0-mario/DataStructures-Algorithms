...
public abstract class AbstractPriorityQueue<K extends Comparable<K>, V> implements PriorityQueue<K, V> {
	/** defines the natural ordering for the keys */
    ...
    public class NaturalOrder implements Comparator<K> {
    	/**
    	 * compares the first key with the second
    	 * @param first key to compare
    	 * @param second key to compare
    	 * @return value of first - second. if 0 they are equals.
    	 */
    ...
    public static class PQEntry<K, V> implements Entry<K, V> {
    	/** key for this PQEntry object */
        private K key;
        /** value for this PQEntry object */
        private V value;
     ...
     * @return a new entry for this Priority Queue
     */
