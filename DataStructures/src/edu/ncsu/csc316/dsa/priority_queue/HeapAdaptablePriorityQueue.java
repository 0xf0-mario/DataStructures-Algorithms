...
public class HeapAdaptablePriorityQueue<K extends Comparable<K>, V> extends HeapPriorityQueue<K, V>
    ...
    public static class AdaptablePQEntry<K, V> extends PQEntry<K, V> {
    	/** allows the PQEntry to be location aware which makes it adaptable */
        private int index;
    ...
    /**
     * replaces key in the entry with the given key
     *  @author MARIO MEDEL (mamedelp)
     */
    @Override
    ...
    /**
     * 
     * replaces value in the entry with the given value
     * @param entry to replace with a new value
