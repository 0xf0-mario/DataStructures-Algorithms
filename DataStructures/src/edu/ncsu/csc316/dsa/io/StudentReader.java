...
public class StudentReader {
	...
	private static Student processLine(String line) {
		...
		//FIRST_NAME,LAST_NAME,UNITY_ID,STUDENT_ID,GPA,CREDIT_HOURS
		Student newStudent = new Student(scanLine.next(), scanLine.next(), scanLine.next(), 
				Integer.parseInt(scanLine.next()), Double.parseDouble(scanLine.next()), Integer.parseInt(scanLine.next()));
