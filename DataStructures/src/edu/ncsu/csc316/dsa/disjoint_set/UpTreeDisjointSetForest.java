...
public class UpTreeDisjointSetForest<E> implements DisjointSetForest<E> {
     ...
     * @author Dr. King
     *
     * @param <E> type of the up tree node 
     */
    private static class UpTreeNode<E> implements Position<E> {
        ...
        /** the amount of nodes this is linked to, including itself */
        private int count;
         ...
         * UpTreeNode
         * 
         * @param count the amount of nodes linked to this node including itself
         */
    ...
    public void union(Position<E> s, Position<E> t) {
        ...
        UpTreeNode<E> a1 = (UpTreeNode<E>) find(a.getElement());
        UpTreeNode<E> b1 = (UpTreeNode<E>) find(b.getElement());
        
        if(a1.getCount() > b1.getCount()) {
        	a1.setCount(a1.getCount() + b1.getCount());
        	b1.setParent(a1);
        	return;
        }
        b1.setCount(a1.getCount() + b1.getCount());
        a1.setParent(b1);
    }
