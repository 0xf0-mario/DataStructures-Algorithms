 ...
 * 
 * The hash map uses a multiply-and-divide compsression strategy for calculating
...
public class SeparateChainingHashMap<K extends Comparable<K>, V> extends AbstractHashMap<K, V> {
	/** hash table uses seperate chaining so each index position will delegate to a tree map */
    private Map<K, V>[] table;
    /** current number of entries in the hash table (n) or the number of elements */
    private int size;
