...
public abstract class AbstractHashMap<K, V> extends AbstractMap<K, V> {
    ...
    /** randomly generated unless specified alpha value used for MAD compression */
    private long alpha;
    /** randomly generated unless specified beta value used for MAD compression */
    private long beta;

    // The prime number to use for compression strategy
    /** prime number will reduce collisions when compressing */
    private int prime;
