...
public abstract class AbstractMap<K, V> implements Map<K, V> {
    ...
    protected static class MapEntry<K, V> implements Entry<K, V> {
    	/** key used to identify the map entry */
        private K key; //KEY DEFINES THE NATRUAL ORDERING 
        ...
        public MapEntry(K key, V value) {
        	...
        	//Throw ClassCastException if the key is not Comparable
            setKey(key);
            setValue(value);
        }
...
//        		throw new ClassCastException("The key is not Comparable");
//			}
            this.key = key;
        }
    ...
    protected class EntryCollection implements Iterable<Entry<K, V>> {
    	...
    	/**
    	 * list abstract data type which contains Entries with key value pairs
    	 */
        ...
        private class EntryCollectionIterator implements Iterator<Entry<K, V>> {
        	/** iterator to help us iterate through individual entries within the list */
    ...
    protected class KeyIterator implements Iterator<K> {
    	/** iterator used to iterate over Entry K objects*/
        private Iterator<Entry<K, V>> it;
    ...
    protected class ValueIterator implements Iterator<V> {
    	/** used to iterator over the entries within an entry set */
        private Iterator<Entry<K, V>> it;
