...
public class EdgeListGraph<V, E> extends AbstractGraph<V, E> {
	/** list of all the vertices contained in this graph */
    private PositionalList<Vertex<V>> vertexList;
    /** list of all the edges contained in this graph */
    ...
    @Override
    public int numVertices() { return vertexList.size(); }

    @Override
    public Iterable<Vertex<V>> vertices() { return vertexList; }

    @Override
    public int numEdges() { return edgeList.size(); }

    @Override
    public Iterable<Edge<E>> edges() { return edgeList; }
    /** 
     * Validates a given vertex to safely case to GraphVertex
    ...
    /**
     * helper method that returns a list of all the outgoing edges
     * FROM a given vertex
     * @param vertex to check for all the outgoing edges 
     * @return list of all edges that are incident from the vertex
     */
    ...
    /**
     * helper method that finds all the edges that are incident
     * TO a given vertex
     * @param vertex vertex to check for all incident edges
     * @return list of all the incident edges TO the vertex
     */
    ...
    @Override
    public int inDegree(Vertex<V> vertex) { return incomingEdgeList(vertex).size(); }

    @Override
    public Iterable<Edge<E>> outgoingEdges(Vertex<V> vertex) { return outgoingEdgeList(vertex); }

    @Override
    public Iterable<Edge<E>> incomingEdges(Vertex<V> vertex) { return incomingEdgeList(vertex); }
