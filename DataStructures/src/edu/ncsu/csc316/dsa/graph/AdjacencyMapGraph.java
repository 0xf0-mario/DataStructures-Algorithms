...
public class AdjacencyMapGraph<V, E> extends AbstractGraph<V, E> {
	/** list of all the vertices for this graph*/
    private PositionalList<Vertex<V>> vertexList;
    /** list of all the edges for this graph */
    ...
    private class AMVertex extends GraphVertex {
        ...
        /**
         * A map of outgoing edges opposite vertex key, edge to reach opposite vertex value
         */
        private Map<Vertex<V>, Edge<E>> outgoing;

        /**
         * A map of incoming edges opposite vertex key, edge to reach opposite vertex value
         */
     ...
     * 
     * @param v vertex to cast to AMVertex object
