...
public abstract class AbstractGraph<V, E> implements Graph<V, E> {
    ...
    protected class GraphVertex implements Vertex<V> {
    	/** element that's associated with THIS graph vertex */
        private V element;
        /** vertex is "location-aware" */
    ...
    protected class GraphEdge implements Edge<E> {
    	/** the associated element in this edge */
        private E element;
        /** list of 2 vertext which are the end points for THIS edge */
        private Vertex<V>[] endpoints;
        /** Edge is "Location-Aware" */
