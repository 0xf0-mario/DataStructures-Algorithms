...
public class AdjacencyListGraph<V, E> extends AbstractGraph<V, E> {
	/** list of all the vertices contained within this graph */
    private PositionalList<Vertex<V>> vertexList;
    /** list of all the edges contained within this graph */
     ...
     * 
     * @param v vertex to validate for an ALVertex object
     ...
     * 
     * @param e edge to case to an ALEdge object
