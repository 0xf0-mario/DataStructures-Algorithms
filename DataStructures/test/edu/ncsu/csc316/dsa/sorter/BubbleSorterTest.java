...
/**
 * BubbleSorterTest will test the bubble sorting algorithm
 * Comparison based will use the natural order or the given comparator
 * @author Mario Medel
 *
 */
public class BubbleSorterTest {
	/** sorts students based on ID */
	BubbleSorter<Student> studentIdSort;
	/** sorts students based on GPA */
	BubbleSorter<Student> studentGPASort;
	/**
	...
	public void setUp() throws Exception {
		...
		studentIdSort = new BubbleSorter<Student>(idCompare);
		
		StudentGPAComparator gpaCompare = new StudentGPAComparator();
		studentGPASort = new BubbleSorter<Student>(gpaCompare);
	}
	/**
