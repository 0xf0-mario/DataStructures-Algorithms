...
public class LinearProbingHashMapTest {
	/** map  used for linear probing testing */
    ...
    public void setUp() {
        ...
        Map<Integer, String> map4 = new LinearProbingHashMap<Integer, String>(1);
    ...
    public void testPut() {
        ...
        assertEquals("string4", map.put(4, "string4"));
        assertNull(map.put(5, "string5"));
        assertNull(map.put(6, "string6"));
        assertEquals("collision", map.put(7, "string7"));
...
//        assertEquals(7, (int)it.next().getKey());
    ...
    public void testRemove() {
        ...
        assertEquals("string14", map.put(14, "update"));
    }
