...
/** 
 * Skip List map test will ensure proper functionality of the skip list map
 * this data structure should behave similar to the Search Table since both are "ordered"
 * @author Mario Medel
 *
 */
